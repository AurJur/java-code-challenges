...
class StoreItemTest {
    ...
    @Test
    void findLeastExpensive_emptyItems() {
        List<StoreItem> items = List.of();
        assertEquals(Optional.empty(), StoreItem.findLeastExpensive(items));
    }

    @Test
    void findLeastExpensive_oneItem() {
    ...
    @Test
    void findLeastExpensive_sameItems() {
    ...
    @Test
    void findLeastExpensive_sameItemsDifferentDiscounts() {
