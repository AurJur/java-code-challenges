...
class App0202Test {
    ...
    @Test
    void findStudentsWithIncompleteVolunteerEvents_set1() {

        List<String> tony = List.of("Tony");
        List<String> tonyHarry = List.of("Tony", "Harry");
        List<String> tonyHarrySally = List.of("Tony", "Harry", "Sally");

        assertEquals(List.of(), App0202.findStudentsWithIncompleteVolunteerEvents(List.of(), Map.of()));

        List<String> studentsWithIncomplete1 = App0202.findStudentsWithIncompleteVolunteerEvents(studentSet1,
                attendeesMapping1);
        assertEquals(tonyHarry.size(), studentsWithIncomplete1.size());
        assertTrue(studentsWithIncomplete1.containsAll(tonyHarry));

        List<String> studentsWithIncomplete2 = App0202.findStudentsWithIncompleteVolunteerEvents(studentSet2,
                attendeesMapping1);
        assertEquals(tony.size(), studentsWithIncomplete2.size());
        assertTrue(studentsWithIncomplete2.containsAll(tony));

        List<String> studentsWithIncomplete3 = App0202.findStudentsWithIncompleteVolunteerEvents(studentSet3,
                attendeesMapping1);
        assertEquals(tony.size(), studentsWithIncomplete3.size());
        assertTrue(studentsWithIncomplete3.containsAll(tony));

        List<String> studentsWithIncomplete4 = App0202.findStudentsWithIncompleteVolunteerEvents(studentSet1,
                attendeesMapping2);
    ...
    @Test
    void findStudentsWithIncompleteVolunteerEvents_set2() {
        ...
        List<String> studentsWithIncomplete5 = App0202.findStudentsWithIncompleteVolunteerEvents(studentSet2,
                attendeesMapping2);
        assertEquals(tonySally.size(), studentsWithIncomplete5.size());
        assertTrue(studentsWithIncomplete5.containsAll(tonySally));

        List<String> studentsWithIncomplete6 = App0202.findStudentsWithIncompleteVolunteerEvents(studentSet3,
                attendeesMapping2);
        assertEquals(tony.size(), studentsWithIncomplete6.size());
        assertTrue(studentsWithIncomplete6.containsAll(tony));

        List<String> studentsWithIncomplete7 = App0202.findStudentsWithIncompleteVolunteerEvents(studentSet1,
                attendeesMapping3);
        ...
        List<String> studentsWithIncomplete8 = App0202.findStudentsWithIncompleteVolunteerEvents(studentSet2,
                attendeesMapping3);
    ...
    @Test
    void findStudentsWithIncompleteVolunteerEvents_set3() {
        ...
        List<String> studentsWithIncomplete9 = App0202.findStudentsWithIncompleteVolunteerEvents(studentSet3,
                attendeesMapping3);
        assertEquals(tonyMolly.size(), studentsWithIncomplete9.size());
        assertTrue(studentsWithIncomplete9.containsAll(tonyMolly));

        List<String> studentsWithIncomplete10 = App0202.findStudentsWithIncompleteVolunteerEvents(studentSet1,
                attendeesMapping4);
        assertEquals(allStudents.size(), studentsWithIncomplete10.size());
        assertTrue(studentsWithIncomplete10.containsAll(allStudents));

        List<String> studentsWithIncomplete11 = App0202.findStudentsWithIncompleteVolunteerEvents(studentSet2,
                attendeesMapping4);
        ...
        List<String> studentsWithIncomplete12 = App0202.findStudentsWithIncompleteVolunteerEvents(studentSet3,
                attendeesMapping4);
